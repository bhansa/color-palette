...
const newColorInput = (props) => {
  ...
  if (colorInput) {
    ...
    addButton = <button className={classes.addButton} onClick={() => { props.addColor(colorInput); }}>Add</button>;
  }
  else {
    ...
    <div className={classes.modalOverlay}>
      <div className={classes.modalContent}>
        ...
        <div className={classes.inputBody}>
          <input type="text" className={classes.inputField} placeholder="#cccccc" onKeyUp={props.validateColorCode} ref={input => input && input.focus()} />
          { validationMessage }
        </div>
